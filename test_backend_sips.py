...
class LectorSipsTest(unittest.TestCase):
    ...
    def test_extrae_potencias_contratadas_de_la_ficha(self):
        metadatos = {
            f"potencia_contratada_kw_p{i}": f"{100 * i},5"
            for i in range(1, 7)
        }
        potencias = potencias_contratadas_sips(metadatos)
        self.assertEqual(potencias["P1"], 100.5)
        self.assertEqual(potencias["P6"], 600.5)
    ...
    def test_admite_contenido_sips_en_bytes(self):
        contenido = (
            "cups;distribuidora;tarifa atr\n"
            "ES001;DISTRIBUIDORA;3.0TD\n\n"
            "cups;f. fin;f.inicio;ea1;ea2;ea3;ea4;ea5;ea6;"
            "er1;er2;er3;er4;er5;er6;pt1;pt2;pt3;pt4;pt5;pt6\n"
            "ES001;2025-01-31;2024-12-31;1;2;3;4;5;6;"
            "10;20;30;40;50;60;100;200;300;400;500;600\n"
        ).encode("utf-8")

        resultado = leer_sips_completo(contenido)
